            ...
            >
              ...
              <div className="relative glass-strong rounded-lg border border-black/10 dark:border-white/10 overflow-hidden shadow-2xl transition-all flex flex-col h-full group-hover:border-purple-500/50 group-hover:shadow-[0_0_40px_rgba(168,85,247,0.15)] group-hover:-translate-y-1">
                <div className="absolute top-4 left-4 z-20">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 glass rounded-full text-purple-600 dark:text-purple-400 text-[9px] font-black uppercase tracking-widest border border-purple-500/30">
                ...
                <div className="aspect-[16/10] relative overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10 flex justify-between items-end">
                    <div className="space-y-1 md:space-y-2 text-left">
                      <p className="text-purple-600 dark:text-purple-400 text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">
                        {group.issuer}
                      </p>
                ...
                <div className="mt-auto p-6 md:p-8 bg-white/50 dark:bg-[#0f0117]/50 border-t border-black/5 dark:border-white/5">
                  <div className="flex items-center justify-between text-[10px] md:text-sm">
                    ...
                    <span className="text-purple-600 dark:text-purple-400 font-black uppercase tracking-widest text-[9px] md:text-[10px] group-hover:underline flex items-center gap-1">
              ...
              <div className="lg:w-2/3 bg-black/40 flex items-center justify-center p-4 md:p-12 relative group/viewer overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent pointer-events-none" />
                                <motion.img
                                  ...
                                  alt={`${selectedGroup.images[currentImgIndex].title} - Certificate Preview`}
              ...
              <div className="lg:w-1/3 p-8 md:p-14 flex flex-col justify-between bg-white dark:bg-[#1a0b2e] relative">
                ...
                <div className="pt-10 flex flex-col gap-4">
                  <a
                    ...
                    download
                    className="w-full py-5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-2xl font-bold flex items-center justify-center gap-3 transition-all shadow-xl shadow-purple-500/20 hover:scale-[1.02] active:scale-95"
                  >
                    Download Certificate <Download className="w-5 h-5" />
                  </a>
